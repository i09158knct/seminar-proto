  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved review as @review" do
        ...
        post :create, {:review => { "answer_id" => "invalid value" }}, valid_session
        assigns(:review).should be_a_new(Review)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested review" do
        ...
        Review.any_instance.should_receive(:update_attributes).with({ "answer_id" => "1" })
        put :update, {:id => review.to_param, :review => { "answer_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the review as @review" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Review.any_instance.stub(:save).and_return(false)
        put :update, {:id => review.to_param, :review => { "answer_id" => "invalid value" }}, valid_session
        assigns(:review).should eq(review)
      end
